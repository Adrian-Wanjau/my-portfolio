        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Full Stack Software Developer specializing in creating modern, responsive web applications with cutting-edge technologies.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <a href="mailto:contact@adrianwanjau.com" className="text-gray-400 hover:text-white transition-colors">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} Adrian Wanjau. All rights reserved.
            </p>
